...
\begin{frame}{What am I doing?}
  \begin{enumerate}
    \item Compare two approaches for scene voxelization % voxelization is a core part of the algorithm; tessellated version also not restricted to rasterizer
    \item What if voxel sizes were allowed to be continuous? % voxel warping
  \end{enumerate}
\end{frame}
...
\begin{frame}[allowframebreaks]{Rasterized vs. Tesselated Voxels}
  \begin{figure}
    \centering
