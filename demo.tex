  ...
  \begin{enumerate}
    ...
    \item Limited reference material
        \begin{itemize}
          ...
          \item Demo code or part of large engine % most is limited in scope or is tied to an engine, making it difficult to extend or integrate into your own project
        \end{itemize}
    \pause
...
\begin{frame}{Contributions}
  \begin{itemize}
    ...
    \item Comparison two different methods of scene voxelization (rasterization vs.\ tessellation)% voxelization is an important part of many new gi algorithms so we wanted to compare two different methods
