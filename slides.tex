...
\begin{frame}{Radiance Injection}
  ...
  \begin{figure}
    ...
    ~
    \begin{subfigure}[t]{0.475\textwidth}
      \adjincludegraphics[width=\textwidth,trim={{0.1\width} 0 {0.1\width} 0},clip]{shadowmap}
    \end{subfigure}
  \end{figure}
\end{frame}}
...
\begin{frame}{Future Work}
  ...
  \begin{itemize}
    ...
    \item Fully implement RSMs, LPVs, and VCT (as described in research paper) for direct comparison % can't really do this right now since there are too many differences between engines to make a fair comparison. also what assets do they use and what other techniques?
