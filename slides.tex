...
\begin{frame}{Overview of Renderer}
  \begin{figure}
    ...
    \begin{subfigure}[t]{0.32\textwidth}
      \includegraphics[width=\textwidth]{gi_step2}
      \caption{Voxelize}
    \end{subfigure}
    \begin{subfigure}[t]{0.32\textwidth}
      \includegraphics[width=\textwidth]{gi_step1}
      \caption{Direct lighting}
    \end{subfigure}
    \begin{subfigure}[t]{0.32\textwidth}
      \includegraphics[width=\textwidth]{gi_step3}
      \caption{Inject direct lighting into voxels}
    \end{subfigure}

    \begin{subfigure}[t]{0.32\textwidth}
      \includegraphics[width=\textwidth]{gi_step4}
      \caption{Filter voxels}
    \end{subfigure}
    \begin{subfigure}[t]{0.32\textwidth}
      \includegraphics[width=\textwidth]{gi_step5}
